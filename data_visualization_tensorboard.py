...
if __name__ == "__main__":
    ...
    print(f"Initializing DataLoader with batch_size={batch_size} and num_workers={num_workers}...")
    ...
    for i, batch_images in enumerate(tqdm(data_loader, desc="Processing Batches")):
        ...
        batch_labels = [os.path.basename(path) for path in image_paths[start_idx:end_idx]]
